...
def parse_categories(self):
    ...
    ne_obrab = []
    obrab = []
    fp = open("/home/mikhail/Projects/bert_ozon/Parsing/collecting_data/taxonomy/full_categories.txt", 'r')
    i = 0
    for line in fp:
        print(i)
        i += 1
    ...
    df1.to_csv("/home/mikhail/Projects/bert_ozon/src/TESTING/categories.csv", encoding='utf-8', index=False)
"""