...
def create_categories3_list():
    path = "/bert_ozon/Parsing/collecting_data/taxonomy/ozon_taxonomy_api.json"
    ...
    path = "/bert_ozon/Parsing/collecting_data/taxonomy/categories3_list.txt"
...
def create_full_categories_list():
    ...
    path = "/bert_ozon/Parsing/collecting_data/taxonomy/full_categories.txt"
    with open(path, 'w') as f:
        for item in categories3_info_list:
            # fp.write(item + '\n')
            f.writelines("%s\n" % item)
